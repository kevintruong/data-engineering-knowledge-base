...
Instances are billed when they’re in a {{c1::running state}} – need to stop or terminate to avoid paying.

Charging by {{c2:the hour or second}} (by the second with Linux instances only).
